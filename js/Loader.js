...
export const ASSETS_BASE = 'https://raw.githubusercontent.com/mrdoob/Starter-Kit-Racing/master/';

const sharedColormap = new THREE.TextureLoader().load( ASSETS_BASE + 'models/Textures/colormap.png' );
